      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="threads_list.html">Your Threads</a></li>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              <tr>
                ...
                <td><a href="thread.html">What stuff do you have in your closet?</a></td>
              ...
              <tr>
                ...
                <td><a href="thread.html">Backhoes and fronthoes: the great debate</a></td>
                <td class="text-right" style="padding-right:38px;"><% getThreads()% >x</td>
              </tr>
              <tr>
                <td class="col-sm-1 col-lg-1"><span class="label label-success">Rising</span></td>
                <td><a href="thread.html">Belligerence in the courtroom is a felony</a></td>
                <td class="text-right" style="padding-right:38px;"><% getThreads()% >x</td>
              </tr>
              <tr>
                <td class="col-sm-1 col-lg-1"><span class="label label-danger">Falling</span></td>
                <td><a href="thread.html">2001: The Based God oddesy</a></td>
                <td class="text-right" style="padding-right:38px;"><% getThreads()% >x</td>
              </tr>
