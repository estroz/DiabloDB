...
//	}
	 ...
	 */
	public ArrayList<Comment> getUserComments(String userName) throws SQLException {
		ArrayList<ArrayList<Object>> arr = getSpecificUser(userName);
		ArrayList<Object> os = arr.get(2);
	 ...
	 */
	public ArrayList<Thread> getUserThreads(String userName) throws SQLException {
		ArrayList<ArrayList<Object>> arr = getSpecificUser(userName);
		ArrayList<Object> os = arr.get(1);
	 ...
	 */
	public ArrayList<Page> getUserPages(String userName) throws SQLException {
		ArrayList<ArrayList<Object>> arr = getSpecificUser(userName);
		ArrayList<Object> os = arr.get(0);
	...
	/*
	 * Returns a all pages and their creators
	 */
	public ArrayList<Page> getAllPagesAndCreators() throws SQLException {
...
//		assert isComment != null;
	...
	public void adminLockThread(String threadID, String posterName) throws SQLException {
		Statement stmnt = this.connection.createStatement();
		...
		int promote = stmnt.executeUpdate("UPDATE Thread SET isLockedFlag = 1 WHERE ThreadID = '"+threadID+"'");
		assert promote == 0;
	}
