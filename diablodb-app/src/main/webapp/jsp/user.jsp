      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="/jsp/user.jsp">Profile</a></li>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              <tr>
                ...
                <td class="col-sm-1 col-lg-1"><a href="/jsp/page.jsp">Page</a></td>
                <td><a href="/jsp/page.jsp">What stuff do you have in your closet?</a></td>
              </tr>
              <tr>
                <td class="col-sm-1 col-lg-1"><span class="label label-default">Neutral</span></td>
                <td class="col-sm-1 col-lg-1"><a href="/jsp/page.jsp">Thread</td></a>
                <td><a href="/jsp/page.jsp">Backhoes and fronthoes: the great debate</t></a>
              </tr>
              <tr>
                <td class="col-sm-1 col-lg-1"><span class="label label-danger"></span></td>
                <td class="col-sm-1 col-lg-1"><a href="/jsp/page.jsp">Page</a></td>
                <td><a href="/jsp/page.jsp">SauceGoss</a></td>
              </tr>
              <tr>
                <td class="col-sm-1 col-lg-1"><span class="label label-success">Rising</span></td>
                <td class="col-sm-1 col-lg-1"><a href="/jsp/page.jsp">Comment</a></td>
                <td><a href="/jsp/page.jsp">Do you even go here?</a></td>
              </tr>
