...
<html lang="en">
  ...
  <body role="document">
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="sidebar">
        <a href="/jsp/create_thread.jsp"><button class="btn btn-primary">Create thread</button></a>
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <table class="table table-default">
            <thead>
              <tr>
                <th class="col-sm-1 col-lg-1">Votes</th>
                <th>Thread</th>
            ...
            <tbody>
              <tr>
                <td class="col-sm-1 col-lg-1"><% getThreadVotes() %></td>
                <td><a href="/jsp/thread.jsp">What stuff do you have in your closet?</a></td>
                <td class="text-right"><a href="/jsp/user.jsp">Brett</td></a>
              </tr>
              <tr>
                <td class="col-sm-1 col-lg-1"><% getThreadVotes() %></td>
                <td><a href="/jsp/thread.jsp">Backhoes and fronthoes: the great debate</t></a>
                <td class="text-right"><a href="/jsp/user.jsp">Josh</td></a>
              </tr>
              <tr>
                <td class="col-sm-1 col-lg-1"><% getThreadVotes() %></td>
                <td><a href="/jsp/thread.jsp">Belligerence in the courtroom is a felony</a></td>
                <td class="text-right"><a href="/jsp/user.jsp">Sam</td></a>
              </tr>
              <tr>
                <td class="col-sm-1 col-lg-1"><% getThreadVotes() %></td>
                <td><a href="/jsp/thread.jsp">2001: The Based God oddesy</a></td>
                <td class="text-right"><a href="/jsp/user.jsp">Eric</td></a>
              </tr>
