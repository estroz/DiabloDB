...
<html lang="en">
  <head>
    ...
    <link href="../css/comments_list.css" rel="stylesheet">
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="comments_list.html">Your Comments</a></li>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              <tr>
                ...
                <td><a href="index.html">What stuff do you have in your closet?</a></td>
              </tr>
              <tr>
                <td class="col-sm-1 col-lg-1"><span class="label label-default">Neutral</span></td>
                <td><a href="">Backhoes and fronthoes: the great debate</a></td>
              </tr>
              <tr>
                <td class="col-sm-1 col-lg-1"><span class="label label-success">Rising</span></td>
                <td><a href="">Belligerence in the courtroom is a felony</a></td>
              </tr>
              <tr>
                <td class="col-sm-1 col-lg-1"><span class="label label-danger">Falling</span></td>
                <td><a href="">2001: The Based God oddesy</a></td>
              </tr>
